...
export default function EditEntry(){
    ...
    return(
        <section className="flex justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 dark:bg-gray-600 dark:text-gray-900 p-8 rounded-md">
            ...
            <button onClick={(e) => {handleSend(e)}} className="bg-blue-400 hover:bg-blue-600 font-semibold text-white dark:text-gray-900 p-3 rounded-md">Update</button>
        </section>
    )
}